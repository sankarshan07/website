...
const Header: React.FC = () => {
    ...
    const hobbies = {
        ...
        "AI": <SiYoutubegaming className={`text-pink-500`} size={30}/>,
        // "Resume": <HiDocumentText size={30} onClick={handleResumeDownload} style={{cursor: 'pointer'}}/>
    }
    return (
        <section
            ...
            {/* <div className="relative transition duration-500 top-32 w-full flex justify-center items-center">
  <div className="absolute mix-blend-plus-lighter bg-lime-500 
    dark:mix-blend-multiply dark:bg-green-600 
    animate-blob top-0 -left-4 w-72 h-72 md:w-[450px] md:h-[450px] rounded-full filter blur-xl"></div>
    
  <div className="absolute mix-blend-plus-lighter bg-rose-400
    dark:mix-blend-multiply dark:bg-coral-500
    z-1 animate-blob -bottom-80 left-36 md:left-60 w-72 h-72 md:w-[450px] md:h-[450px] rounded-full filter blur-xl"></div>
    
  <div className="absolute mix-blend-screen bg-sky-400
    dark:mix-blend-multiply dark:bg-purple-500 
    animate-blob -bottom-40 left-20 w-72 h-72 md:w-[450px] md:h-[450px] rounded-full filter blur-xl"></div>
</div> */}
...
<div className="relative transition duration-500 top-32 w-full flex justify-center items-center">
  <div className="absolute mix-blend-plus-lighter bg-amber-400
    dark:mix-blend-multiply dark:bg-yellow-600
    animate-blob top-0 -left-4 w-72 h-72 md:w-[450px] md:h-[450px] rounded-full filter blur-xl"></div>
    
  <div className="absolute mix-blend-plus-lighter bg-cyan-400
    dark:mix-blend-multiply dark:bg-teal-600
    z-1 animate-blob -bottom-80 left-36 md:left-60 w-72 h-72 md:w-[450px] md:h-[450px] rounded-full filter blur-xl"></div>
    
  <div className="absolute mix-blend-screen bg-violet-500
    dark:mix-blend-multiply dark:bg-indigo-600 
    animate-blob -bottom-40 left-20 w-72 h-72 md:w-[450px] md:h-[450px] rounded-full filter blur-xl"></div>
</div>
            ...
            <SpringText className={'relative z-999 inline-flex'}>
                ...
                <motion.h1
                    ...
                    animate={{y: 0, opacity: 1}}
                    transition={{delay: .5, duration: .6}}
                    className={`pb-2 ml-5 text-8xl z-99 font-Inter transition duration-300 tracking-wide 
                    //dark
                    text-white 
                    //light
                    dark:text-black 
            ...
            <motion.h1
                ...
                animate={{y: 0, opacity: 1}}
                transition={{delay: .6, duration: .6}}
                className={`text-neutral-600 text-4xl font-Inter  tracking-wide italic dark:text-gray-950 transition duration-300`}>
                <span className={'font-black'}>{'<Code Create Conquer/>'}</span>
            </motion.h1>
            <motion.div
                initial={{y: 10, opacity: 0}}
                animate={{y: 0, opacity: 1}}
